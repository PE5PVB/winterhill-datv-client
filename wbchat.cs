...
namespace datvreceiver
{
    public partial class wbchat : Form
    {
        ...
        private void wbchat_Load(object sender, EventArgs e)
        {
            ...
            if (Properties.Settings.Default.default_chat_nick.Length > 0)
            {
                txtNick.Text = Properties.Settings.Default.default_chat_nick;
            }
        ...
        private void setNick()
        {
            if (client.Connected)
            {
                ...
                if (nick.Length > 0)
                {
                    ...
                    Properties.Settings.Default.default_chat_nick = nick;
